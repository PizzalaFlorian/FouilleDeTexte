 ...
 */
public class Rep_TFCL_BOW2G extends Rep {
    ...
    static List<String> lemmasToIgnore = new ArrayList<>(Arrays.asList(
            "Ítre", "bref", "haut", "rÈsultat", "oriental", "annoncer", "trop_cuire",
            "cela", "avant",
            "bientÙt", "menu", "autre", 
            "soir", "arrivÈ", "l‡", 
            "encore", "patron", "lyonnais", 
            "frire", "point", "mettre", 
            "cafÈ", "tartare", "chocolat", 
            "lors", "fille", "sucrer",
            "g‚teau", "menu_enfant", "boeuf", 
    ...
    public Rep_TFCL_BOW2G(Tokenizer tokenizer, Lexicon lex, int maxSize, int minCount) {
    ...
    public double[] buildFeatures(Review review) {
        double[] vector = null;
        if (fset.isFinalized()) {
            // l'ensemble des traits est d√©j√† construit, donc l√† on construit
        ...
        // cr√©er l'ensemble des traits BOW2G
