 ...
 */
public class NN_H10tanhH01tanh extends NN {

    public NN_H10tanhH01tanh(int inputSize, int outputSize) {
        ...
        // hidden layer(s)
        net.addLayer(new BasicLayer(tanh, true, (int) (inputSize * 1.0)));
        net.addLayer(new BasicLayer(tanh, true, (int) (inputSize * 0.1)));
        // ouput layer 
