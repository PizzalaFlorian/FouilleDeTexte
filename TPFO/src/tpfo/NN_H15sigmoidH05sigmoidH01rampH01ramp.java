...
public class NN_H15sigmoidH05sigmoidH01rampH01ramp extends NN {
	
	public NN_H15sigmoidH05sigmoidH01rampH01ramp(int inputSize, int outputSize) {
        ...
        // hidden layer(s)
        net.addLayer(new BasicLayer(sigmoid, true, (int) (inputSize*1.5)));
        net.addLayer(new BasicLayer(sigmoid, true, (int) (inputSize*0.5)));
