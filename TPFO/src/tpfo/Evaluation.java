...
public class Evaluation {
    ...
    int dataSize;
    int errCount;
    int[] tp = new int[ClassLabel.size()];//vrai positif bonne réponse
    int[] fp = new int[ClassLabel.size()];//faux positif bonne réponse alors que c'était faux
    int[] tn = new int[ClassLabel.size()];//vrai négatif mauvaise réponse alors que c'était bon
    int[] fn = new int[ClassLabel.size()];//faux négatif mauvaise réponse
