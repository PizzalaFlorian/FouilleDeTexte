 ...
 */
public class NN_H90tanhH20tanh extends NN {

    public NN_H90tanhH20tanh(int inputSize, int outputSize) {
        ...
        // hidden layer(s)
        net.addLayer(new BasicLayer(tanh, true, (int) (inputSize * 20)));
        net.addLayer(new BasicLayer(tanh, true, (int) inputSize*2));
        // ouput layer 
