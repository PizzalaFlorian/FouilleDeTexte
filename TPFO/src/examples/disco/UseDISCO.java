...
public class UseDISCO {
    ...
    /**
     * **********************************************************************
     * Call with: java UseDISCO WORDSPACE-DIR WORD Make sure that disco-2.0.jar
     * is in the classpath. The word space must be of type
     * DISCO.WordspaceType.SIM. Set the JVM heap size to be larger than the word
     * space that will be loaded into RAM, otherwise an OutOfMemoryError will be
     * thrown!
     *
     * @param args
...
//        discoDir = args[0];
        ...
        discoDir = "/home/florian/workspace/fouilleTexte/TPFO/resources/fr-general-20151126-lm-word2vec-sim";
...
//        word = args[1];
	 ...
	 ***************************************
        ...
        DISCO disco;
        try {
            disco = new DISCO(discoDir, false);// le boolean -> dois ont travailler en ram O/n
...
//        }
        ...
        float sim = disco.semanticSimilarity("eau", "délicieux",
